...
CREATE TYPE massoftware.type_Transporte_level_1 AS (
		...
		, Transporte_domicilio VARCHAR(150)   				-- 13
		, Transporte_comentario VARCHAR(300)  				-- 14
);
...
CREATE TYPE massoftware.type_Transporte_level_2 AS (
		...
		, Transporte_domicilio VARCHAR(150)   				-- 18
		, Transporte_comentario VARCHAR(300)  				-- 19
);
...
CREATE TYPE massoftware.type_Transporte_level_3 AS (
		...
		, Transporte_domicilio VARCHAR(150)    				-- 25
		, Transporte_comentario VARCHAR(300)   				-- 26
);
...
CREATE TYPE massoftware.type_Carga_level_1 AS (
		...
		, Transporte_domicilio VARCHAR(150)   				-- 11
		, Transporte_comentario VARCHAR(300)  				-- 12
);
...
CREATE TYPE massoftware.type_Carga_level_2 AS (
		...
		, Transporte_domicilio VARCHAR(150)   				-- 16
		, Transporte_comentario VARCHAR(300)  				-- 17
);
...
CREATE TYPE massoftware.type_Carga_level_3 AS (
		...
		, Transporte_domicilio VARCHAR(150)   				-- 21
		, Transporte_comentario VARCHAR(300)  				-- 22
);
...
CREATE TYPE massoftware.type_TransporteTarifa_level_1 AS (
		...
		, Ciudad_nombre VARCHAR(50)                             				-- 8
		, Ciudad_departamento VARCHAR(50)                       				-- 9
		, Ciudad_numeroAFIP INTEGER                             				-- 10
		, Ciudad_provincia VARCHAR(36)                          				-- 11
		, TransporteTarifa_precioFlete DECIMAL(13, 5)           				-- 12
		, TransporteTarifa_precioUnidadFacturacion DECIMAL(13, 5)				-- 13
		, TransporteTarifa_precioUnidadStock DECIMAL(13, 5)     				-- 14
		, TransporteTarifa_precioBultos DECIMAL(13, 5)          				-- 15
		, TransporteTarifa_importeMinimoEntrega DECIMAL(13, 5)  				-- 16
		, TransporteTarifa_importeMinimoCarga DECIMAL(13, 5)    				-- 17
);
...
CREATE TYPE massoftware.type_TransporteTarifa_level_2 AS (
		...
		, Provincia_nombre VARCHAR(50)                          				-- 22
		, Provincia_abreviatura VARCHAR(5)                      				-- 23
		...
		, TransporteTarifa_precioFlete DECIMAL(13, 5)           				-- 28
		, TransporteTarifa_precioUnidadFacturacion DECIMAL(13, 5)				-- 29
		, TransporteTarifa_precioUnidadStock DECIMAL(13, 5)     				-- 30
		, TransporteTarifa_precioBultos DECIMAL(13, 5)          				-- 31
		, TransporteTarifa_importeMinimoEntrega DECIMAL(13, 5)  				-- 32
		, TransporteTarifa_importeMinimoCarga DECIMAL(13, 5)    				-- 33
);
...
CREATE TYPE massoftware.type_TransporteTarifa_level_3 AS (
		...
		, Ciudad_nombre VARCHAR(50)                             				-- 22
		, Ciudad_departamento VARCHAR(50)                       				-- 23
		, Ciudad_numeroAFIP INTEGER                             				-- 24
		, Provincia_id VARCHAR(36)                              				-- 25
		, Provincia_numero INTEGER                              				-- 26
		, Provincia_nombre VARCHAR(50)                          				-- 27
		, Provincia_abreviatura VARCHAR(5)                      				-- 28
		...
		, Pais_nombre VARCHAR(50)                               				-- 34
		, Pais_abreviatura VARCHAR(5)                           				-- 35
		, TransporteTarifa_precioFlete DECIMAL(13, 5)           				-- 36
		, TransporteTarifa_precioUnidadFacturacion DECIMAL(13, 5)				-- 37
		, TransporteTarifa_precioUnidadStock DECIMAL(13, 5)     				-- 38
		, TransporteTarifa_precioBultos DECIMAL(13, 5)          				-- 39
		, TransporteTarifa_importeMinimoEntrega DECIMAL(13, 5)  				-- 40
		, TransporteTarifa_importeMinimoCarga DECIMAL(13, 5)    				-- 41
);
