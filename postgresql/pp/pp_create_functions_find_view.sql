...
DROP FUNCTION IF EXISTS massoftware.f_Usuario(
	...
	, nombreWord0Arg6    VARCHAR(50)(15)	-- 6
	, nombreWord1Arg7    VARCHAR(50)(15)	-- 7
	, nombreWord2Arg8    VARCHAR(50)(15)	-- 8
	, nombreWord3Arg9    VARCHAR(50)(15)	-- 9
	, nombreWord4Arg10   VARCHAR(50)(15)	-- 10
...
DROP FUNCTION IF EXISTS massoftware.f_Zona(
	...
	, nombreWord0Arg5   VARCHAR(50)(15)	-- 5
	, nombreWord1Arg6   VARCHAR(50)(15)	-- 6
	, nombreWord2Arg7   VARCHAR(50)(15)	-- 7
	, nombreWord3Arg8   VARCHAR(50)(15)	-- 8
	, nombreWord4Arg9   VARCHAR(50)(15)	-- 9
...
DROP FUNCTION IF EXISTS massoftware.f_Pais(
	...
	, nombreWord3Arg9         VARCHAR(50)(15)	-- 9
	, nombreWord4Arg10        VARCHAR(50)(15)	-- 10
	, abreviaturaWord0Arg11   VARCHAR(5)(15) 	-- 11
	, abreviaturaWord1Arg12   VARCHAR(5)(15) 	-- 12
	, abreviaturaWord2Arg13   VARCHAR(5)(15) 	-- 13
	, abreviaturaWord3Arg14   VARCHAR(5)(15) 	-- 14
	, abreviaturaWord4Arg15   VARCHAR(5)(15) 	-- 15
...
) RETURNS SETOF massoftware.type_Provincia_1 AS $$
...
) RETURNS SETOF massoftware.type_Ciudad_2 AS $$
...
) RETURNS SETOF massoftware.type_CodigoPostal_3 AS $$
...
) RETURNS SETOF massoftware.type_Transporte_3 AS $$
...
) RETURNS SETOF massoftware.type_Carga_3 AS $$
...
) RETURNS SETOF massoftware.type_TransporteTarifa_3 AS $$
...
) RETURNS SETOF massoftware.type_Moneda_1 AS $$
...
DROP FUNCTION IF EXISTS massoftware.f_MotivoBloqueoCliente(
	...
	, nombreWord3Arg9             VARCHAR(50)(15)	-- 9
	, nombreWord4Arg10            VARCHAR(50)(15)	-- 10
	, clasificacionClienteArg11   VARCHAR(36)    	-- 11
...
) RETURNS SETOF massoftware.type_MotivoBloqueoCliente_1 AS $$
