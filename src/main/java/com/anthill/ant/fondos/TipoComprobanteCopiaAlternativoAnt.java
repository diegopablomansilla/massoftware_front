...
public class TipoComprobanteCopiaAlternativoAnt extends Ant {

	public TipoComprobanteCopiaAlternativoAnt(Anthill anthill) {
		super(anthill);
	}
	...
	public Clazz build() throws Exception {
		...
		c.setName("TipoComprobanteCopiaAlternativo");
		c.setNamePlural("TiposComprobantesCopiasAlternativos");
