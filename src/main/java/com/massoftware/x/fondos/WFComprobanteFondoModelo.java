...
public class WFComprobanteFondoModelo extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<ComprobanteFondoModelo> itemBI;
	...
	public WFComprobanteFondoModelo(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((ComprobanteFondoModelo) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((ComprobanteFondoModelo) obj);
	}

	protected BeanItem<ComprobanteFondoModelo> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<ComprobanteFondoModelo>(new ComprobanteFondoModelo());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			ComprobanteFondoModelo item = getService().findById(id);
