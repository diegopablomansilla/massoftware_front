...
public class WFTipoComprobanteConcepto extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TipoComprobanteConcepto> itemBI;
	...
	public WFTipoComprobanteConcepto(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TipoComprobanteConcepto) obj);
	}

	protected BeanItem<TipoComprobanteConcepto> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TipoComprobanteConcepto>(new TipoComprobanteConcepto());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TipoComprobanteConcepto item = getService().findById(id);
