...
public class WFClaseComprobante extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<ClaseComprobante> itemBI;
	...
	public WFClaseComprobante(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((ClaseComprobante) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((ClaseComprobante) obj);
	}

	protected BeanItem<ClaseComprobante> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<ClaseComprobante>(new ClaseComprobante());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			ClaseComprobante item = getService().findById(id);
