...
public class WFTicketControlDenunciados extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TicketControlDenunciados> itemBI;
	...
	public WFTicketControlDenunciados(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((TicketControlDenunciados) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TicketControlDenunciados) obj);
	}

	protected BeanItem<TicketControlDenunciados> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TicketControlDenunciados>(new TicketControlDenunciados());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TicketControlDenunciados item = getService().findById(id);
