...
public class WFTipoComprobanteCopiaAlternativo extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TipoComprobanteCopiaAlternativo> itemBI;
	...
	public WFTipoComprobanteCopiaAlternativo(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((TipoComprobanteCopiaAlternativo) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TipoComprobanteCopiaAlternativo) obj);
	}

	protected BeanItem<TipoComprobanteCopiaAlternativo> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TipoComprobanteCopiaAlternativo>(new TipoComprobanteCopiaAlternativo());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TipoComprobanteCopiaAlternativo item = getService().findById(id);
