...
public class WFCuentaFondoBancoCopia extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CuentaFondoBancoCopia> itemBI;
	...
	public WFCuentaFondoBancoCopia(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CuentaFondoBancoCopia) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((CuentaFondoBancoCopia) obj);
	}

	protected BeanItem<CuentaFondoBancoCopia> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<CuentaFondoBancoCopia>(new CuentaFondoBancoCopia());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CuentaFondoBancoCopia item = getService().findById(id);
