...
public class WFTalonarioControladorFizcal extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TalonarioControladorFizcal> itemBI;
	...
	public WFTalonarioControladorFizcal(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TalonarioControladorFizcal) obj);
	}

	protected BeanItem<TalonarioControladorFizcal> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TalonarioControladorFizcal>(new TalonarioControladorFizcal());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TalonarioControladorFizcal item = getService().findById(id);
