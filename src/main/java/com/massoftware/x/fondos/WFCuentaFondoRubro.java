...
public class WFCuentaFondoRubro extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CuentaFondoRubro> itemBI;
	...
	public WFCuentaFondoRubro(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CuentaFondoRubro) item).setNumero(getService().nextValueNumero());
	...
	protected BeanItem<CuentaFondoRubro> getItemBIC() throws Exception {
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CuentaFondoRubro item = getService().findById(id);
