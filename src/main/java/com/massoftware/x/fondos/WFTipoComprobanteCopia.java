...
public class WFTipoComprobanteCopia extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TipoComprobanteCopia> itemBI;
	...
	public WFTipoComprobanteCopia(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((TipoComprobanteCopia) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TipoComprobanteCopia) obj);
	}

	protected BeanItem<TipoComprobanteCopia> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TipoComprobanteCopia>(new TipoComprobanteCopia());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TipoComprobanteCopia item = getService().findById(id);
