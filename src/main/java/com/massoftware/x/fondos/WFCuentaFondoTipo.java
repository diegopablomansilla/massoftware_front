...
public class WFCuentaFondoTipo extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CuentaFondoTipo> itemBI;
	...
	public WFCuentaFondoTipo(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CuentaFondoTipo) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((CuentaFondoTipo) obj);
	}

	protected BeanItem<CuentaFondoTipo> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<CuentaFondoTipo>(new CuentaFondoTipo());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CuentaFondoTipo item = getService().findById(id);
