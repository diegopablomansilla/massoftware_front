...
public class WFComportamientoComprobante extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<ComportamientoComprobante> itemBI;
	...
	public WFComportamientoComprobante(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((ComportamientoComprobante) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((ComportamientoComprobante) obj);
	}

	protected BeanItem<ComportamientoComprobante> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<ComportamientoComprobante>(new ComportamientoComprobante());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			ComportamientoComprobante item = getService().findById(id);
