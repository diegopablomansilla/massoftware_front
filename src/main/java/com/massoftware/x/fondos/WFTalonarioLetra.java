...
public class WFTalonarioLetra extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TalonarioLetra> itemBI;
	...
	public WFTalonarioLetra(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TalonarioLetra) obj);
	}

	protected BeanItem<TalonarioLetra> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TalonarioLetra>(new TalonarioLetra());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TalonarioLetra item = getService().findById(id);
