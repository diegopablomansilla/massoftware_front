...
public class WLBanco extends WindowListado {
	...
	protected OptionGroupEntityBoolean bloqueadoOPT;
	...
	protected Component buildFiltros() throws Exception {		
		...
		bloqueadoOPT = new OptionGroupEntityBoolean(this, filterBI, "bloqueadoInt", "Activas", "Obsoletas", "Todas", true, 0);
	...
	protected Component buildFiltrosLayout() throws Exception {	
		...
		if (bloqueadoOPT != null) {
			filaFiltroHL.addComponent(bloqueadoOPT);
		}
...
// GENERATED BY ANTHILL 2019-07-08T12:47:40.750-03:00[America/Buenos_Aires]