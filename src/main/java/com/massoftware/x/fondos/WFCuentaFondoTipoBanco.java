...
public class WFCuentaFondoTipoBanco extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CuentaFondoTipoBanco> itemBI;
	...
	public WFCuentaFondoTipoBanco(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CuentaFondoTipoBanco) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((CuentaFondoTipoBanco) obj);
	}

	protected BeanItem<CuentaFondoTipoBanco> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<CuentaFondoTipoBanco>(new CuentaFondoTipoBanco());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CuentaFondoTipoBanco item = getService().findById(id);
