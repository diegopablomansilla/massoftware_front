...
public class WFTipoSucursal extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TipoSucursal> itemBI;
	...
	public WFTipoSucursal(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((TipoSucursal) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TipoSucursal) obj);
	}

	protected BeanItem<TipoSucursal> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TipoSucursal>(new TipoSucursal());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TipoSucursal item = getService().findById(id);
