...
public class WFDepositoModulo extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<DepositoModulo> itemBI;
	...
	public WFDepositoModulo(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((DepositoModulo) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((DepositoModulo) obj);
	}

	protected BeanItem<DepositoModulo> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<DepositoModulo>(new DepositoModulo());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			DepositoModulo item = getService().findById(id);
