...
public class WFSeguridadModulo extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<SeguridadModulo> itemBI;
	...
	public WFSeguridadModulo(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((SeguridadModulo) item).setNumero(getService().nextValueNumero());
	...
	protected BeanItem<SeguridadModulo> getItemBIC() throws Exception {
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			SeguridadModulo item = getService().findById(id);
