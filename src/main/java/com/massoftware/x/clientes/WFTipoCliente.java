...
public class WFTipoCliente extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TipoCliente> itemBI;
	...
	public WFTipoCliente(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((TipoCliente) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TipoCliente) obj);
	}

	protected BeanItem<TipoCliente> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TipoCliente>(new TipoCliente());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TipoCliente item = getService().findById(id);
