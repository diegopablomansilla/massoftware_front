...
public class WFCostoVenta extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CostoVenta> itemBI;
	...
	public WFCostoVenta(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CostoVenta) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((CostoVenta) obj);
	}

	protected BeanItem<CostoVenta> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<CostoVenta>(new CostoVenta());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CostoVenta item = getService().findById(id);
