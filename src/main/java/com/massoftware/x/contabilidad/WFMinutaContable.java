...
public class WFMinutaContable extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<MinutaContable> itemBI;
	...
	public WFMinutaContable(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((MinutaContable) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((MinutaContable) obj);
	}

	protected BeanItem<MinutaContable> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<MinutaContable>(new MinutaContable());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			MinutaContable item = getService().findById(id);
