...
public class WFCuentaContableEstado extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CuentaContableEstado> itemBI;
	...
	public WFCuentaContableEstado(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CuentaContableEstado) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((CuentaContableEstado) obj);
	}

	protected BeanItem<CuentaContableEstado> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<CuentaContableEstado>(new CuentaContableEstado());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CuentaContableEstado item = getService().findById(id);
