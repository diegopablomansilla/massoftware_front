...
public class WLAsientoContable extends WindowListado {
	...
	protected DateFieldBox fechaFromTXTB;
	protected DateFieldBox fechaToTXTB;
	...
	protected Component buildFiltros() throws Exception {		
		...
		fechaFromTXTB = new DateFieldBox(this, filterBI, "fechaFrom", false);

		// ------------------------------------------------------------------

		fechaToTXTB = new DateFieldBox(this, filterBI, "fechaTo", false);
...
// GENERATED BY ANTHILL 2019-06-27T10:39:12.794-03:00[America/Buenos_Aires]