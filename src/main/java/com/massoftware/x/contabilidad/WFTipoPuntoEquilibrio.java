...
public class WFTipoPuntoEquilibrio extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<TipoPuntoEquilibrio> itemBI;
	...
	public WFTipoPuntoEquilibrio(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((TipoPuntoEquilibrio) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((TipoPuntoEquilibrio) obj);
	}

	protected BeanItem<TipoPuntoEquilibrio> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<TipoPuntoEquilibrio>(new TipoPuntoEquilibrio());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			TipoPuntoEquilibrio item = getService().findById(id);
