...
public class WFAsientoContableModulo extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<AsientoContableModulo> itemBI;
	...
	public WFAsientoContableModulo(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((AsientoContableModulo) item).setNumero(getService().nextValueNumero());
	...
	protected void setBean(EntityId obj) throws Exception {
		...
		itemBI.setBean((AsientoContableModulo) obj);
	}

	protected BeanItem<AsientoContableModulo> getItemBIC() throws Exception {
		...
		if (itemBI == null) {
			itemBI = new BeanItem<AsientoContableModulo>(new AsientoContableModulo());
		}
		return itemBI;
	}
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			AsientoContableModulo item = getService().findById(id);
