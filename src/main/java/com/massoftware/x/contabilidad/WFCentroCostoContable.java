...
public class WFCentroCostoContable extends WindowForm {


	// -------------------------------------------------------------

	protected BeanItem<CentroCostoContable> itemBI;
	...
	public WFCentroCostoContable(String mode, String id) {
		super(mode, id);					
	}
	...
	protected void setMaxValues(EntityId item) throws Exception {
		...
		((CentroCostoContable) item).setNumero(getService().nextValueNumero());
	...
	protected BeanItem<CentroCostoContable> getItemBIC() throws Exception {
...
//			((EntityId) getItemBIC().getBean()).update();
	...
	protected EntityId queryData() throws Exception {
		try {
			...
			CentroCostoContable item = getService().findById(id);
