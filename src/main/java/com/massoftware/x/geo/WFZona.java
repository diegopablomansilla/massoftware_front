...
public class WFZona extends WindowForm {
	...
	protected TextFieldEntity bonificacionTXT;
	protected TextFieldEntity recargoTXT;


	// -------------------------------------------------------------

	public WFZona(String mode, String id) {
		super(mode, id);					
	}
	...
	protected Component buildCuerpo() throws Exception {
		...
		bonificacionTXT = new TextFieldEntity(itemBI, "bonificacion", this.mode);

		// ------------------------------------------------------------------

		recargoTXT = new TextFieldEntity(itemBI, "recargo", this.mode);
	...
	protected BeanItem<Zona> getItemBIC() throws Exception {
