...
public class SelectorBoxOld extends HorizontalLayout implements Validatable {
	...
	@SuppressWarnings("rawtypes")
	public SelectorBoxOld(BeanItem dtoBI, String attName) throws Exception {
		init(dtoBI, attName, null);
	}

	@SuppressWarnings("rawtypes")
	public SelectorBoxOld(BeanItem dtoBI, String attName, String label2) throws Exception {
