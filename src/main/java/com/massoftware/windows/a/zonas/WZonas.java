package com.massoftware.windows.a.zonas;
...
public class WZonas extends WindowListado {
	...
	private Grid buildItemsGRD() throws Exception {
		...
		itemsGRD.setColumns(new Object[] { "codigo", "nombre", "bonificacion", "recargo" });
	...
	protected void addBeansToItemsBIC() {
		...
		try {
			...
			List<Zona> items = new Zona().find(limit, offset, buildOrderBy(), filterBI.getBean());
