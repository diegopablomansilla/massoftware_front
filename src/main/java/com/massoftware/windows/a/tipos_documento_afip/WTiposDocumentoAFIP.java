package com.massoftware.windows.a.tipos_documento_afip;
...
public class WTiposDocumentoAFIP extends WindowListado {
	...
	protected BeanItemContainer<TipoDocumentoAFIP> getItemsBIC() {
		...
		if (itemsBIC == null) {
			...
			itemsBIC = new BeanItemContainer<TipoDocumentoAFIP>(TipoDocumentoAFIP.class,
					new ArrayList<TipoDocumentoAFIP>());
