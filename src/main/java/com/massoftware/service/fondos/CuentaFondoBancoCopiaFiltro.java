...
public class CuentaFondoBancoCopiaFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public CuentaFondoBancoCopiaFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		CuentaFondoBancoCopiaFiltro other = (CuentaFondoBancoCopiaFiltro) obj;
