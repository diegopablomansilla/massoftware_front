...
public class TipoComprobanteConceptoFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public TipoComprobanteConceptoFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		TipoComprobanteConceptoFiltro other = (TipoComprobanteConceptoFiltro) obj;
