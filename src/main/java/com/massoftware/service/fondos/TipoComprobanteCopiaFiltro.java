...
public class TipoComprobanteCopiaFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public TipoComprobanteCopiaFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		TipoComprobanteCopiaFiltro other = (TipoComprobanteCopiaFiltro) obj;
