...
public class CuentaFondoTipoBancoFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public CuentaFondoTipoBancoFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		CuentaFondoTipoBancoFiltro other = (CuentaFondoTipoBancoFiltro) obj;
