...
public class JuridiccionConvnioMultilateralService {
	...
	public String insert(JuridiccionConvnioMultilateral obj) throws Exception {

		if(obj == null){

			throw new IllegalArgumentException("Se esperaba un objeto JuridiccionConvnioMultilateral no nulo.");
		...
		String sql = "SELECT * FROM massoftware.i_JuridiccionConvnioMultilateral(?, ?, ?, ?)";

		Object[] args = new Object[] {id, numero, nombre, cuentaFondo};
	...
	public String update(JuridiccionConvnioMultilateral obj) throws Exception {
		...
		if(obj.getId() == null || obj.getId().trim().length() == 0){
			...
			throw new IllegalArgumentException("Se esperaba un objeto JuridiccionConvnioMultilateral con id no nulo/vacio.");
		...
		String sql = "SELECT * FROM massoftware.u_JuridiccionConvnioMultilateral(?, ?, ?, ?)";
	...
	public boolean deleteById(String id) throws Exception {
		...
		if(id == null || id.trim().length() == 0){
			...
			throw new IllegalArgumentException("Se esperaba un id (JuridiccionConvnioMultilateral.id) no nulo/vacio.");
		...
		String sql = "SELECT * FROM massoftware.d_JuridiccionConvnioMultilateralById(?)";
	...
	public boolean isExistsNumero(Integer arg) throws Exception {
		...
		if(arg == null || arg.toString().trim().length() == 0){
			...
			throw new IllegalArgumentException("Se esperaba un arg (JuridiccionConvnioMultilateral.numero) no nulo/vacio.");

		}

		String sql = "SELECT * FROM massoftware.f_exists_JuridiccionConvnioMultilateral_numero(?)";
	...
	public boolean isExistsNombre(String arg) throws Exception {
		...
		if(arg == null || arg.toString().trim().length() == 0){
			...
			throw new IllegalArgumentException("Se esperaba un arg (JuridiccionConvnioMultilateral.nombre) no nulo/vacio.");

		}

		arg = arg.trim();

		String sql = "SELECT * FROM massoftware.f_exists_JuridiccionConvnioMultilateral_nombre(?)";
	...
	public Integer nextValueNumero() throws Exception {
		...
		String sql = "SELECT * FROM massoftware.f_next_JuridiccionConvnioMultilateral_numero()";
	...
	public Long count() throws Exception {
		...
		String sql = "SELECT COUNT(*) FROM massoftware.JuridiccionConvnioMultilateral;";
	...
	public List<JuridiccionConvnioMultilateral> findByNumeroOrNombre(String arg) throws Exception {


		if (arg == null || arg.trim().length() == 0) {

			throw new IllegalArgumentException("Se esperaba un arg (JuridiccionConvnioMultilateral.numero o JuridiccionConvnioMultilateral.nombre) no nulo/vacio.");
		...
		//------------ buscar por Nº juridicción

		if(UtilNumeric.isInteger(arg)) {

			JuridiccionConvnioMultilateralFiltro filtroNumero = new JuridiccionConvnioMultilateralFiltro();
			...
			List<JuridiccionConvnioMultilateral> listadoNumero = find(filtroNumero);
		...
		JuridiccionConvnioMultilateralFiltro filtroNombre = new JuridiccionConvnioMultilateralFiltro();

		filtroNombre.setUnlimited(true);

		filtroNombre.setNombre(arg);

		List<JuridiccionConvnioMultilateral> listadoNombre = find(filtroNombre);
		...
		return new ArrayList<JuridiccionConvnioMultilateral>();
	...
	public JuridiccionConvnioMultilateral findById(String id, Integer level) throws Exception {
		...
		String sql = "SELECT * FROM massoftware.f_JuridiccionConvnioMultilateralById" + levelString + "(?)";
		...
		if(table.length == 1){
			...
			if(row.length == 4) {
				...
				obj = mapper31Fields(row);

				obj._originalDTO = (EntityId) obj.clone();

				return obj;

			} else if(row.length == 90) {

				obj = mapper90Fields(row);

				obj._originalDTO = (EntityId) obj.clone();

				return obj;

			} else if(row.length == 126) {

				obj = mapper126Fields(row);
	...
	public List<JuridiccionConvnioMultilateral> find(JuridiccionConvnioMultilateralFiltro filtro) throws Exception {
		...
		String sql = "SELECT * FROM massoftware.f_JuridiccionConvnioMultilateral" + levelString + "(?, ?, ?, ?, ? , ?, ?, ?)";
		...
		for(int i = 0; i < table.length; i++){
			...
			if(row.length == 4) {
				...
				JuridiccionConvnioMultilateral obj = mapper4Fields(row);
				...
				JuridiccionConvnioMultilateral obj = mapper31Fields(row);
				...
				JuridiccionConvnioMultilateral obj = mapper90Fields(row);
				...
				JuridiccionConvnioMultilateral obj = mapper126Fields(row);
	...
	private JuridiccionConvnioMultilateral mapper4Fields(Object[] row) throws Exception {

		int c = -1;

		String idJuridiccionConvnioMultilateralArg0 = (String) row[++c];
		Integer numeroJuridiccionConvnioMultilateralArg1 = (Integer) row[++c];
		String nombreJuridiccionConvnioMultilateralArg2 = (String) row[++c];
		String cuentaFondoJuridiccionConvnioMultilateralArg3 = (String) row[++c]; // CuentaFondo.id

		JuridiccionConvnioMultilateral obj = new JuridiccionConvnioMultilateral(idJuridiccionConvnioMultilateralArg0, numeroJuridiccionConvnioMultilateralArg1, nombreJuridiccionConvnioMultilateralArg2, cuentaFondoJuridiccionConvnioMultilateralArg3);
	...
	private JuridiccionConvnioMultilateral mapper31Fields(Object[] row) throws Exception {
	...
	private JuridiccionConvnioMultilateral mapper90Fields(Object[] row) throws Exception {
	...
	private JuridiccionConvnioMultilateral mapper126Fields(Object[] row) throws Exception {
