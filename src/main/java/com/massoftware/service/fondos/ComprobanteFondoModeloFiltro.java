...
public class ComprobanteFondoModeloFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public ComprobanteFondoModeloFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		ComprobanteFondoModeloFiltro other = (ComprobanteFondoModeloFiltro) obj;
