...
public class CuentaContableEstadoFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public CuentaContableEstadoFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		CuentaContableEstadoFiltro other = (CuentaContableEstadoFiltro) obj;
