...
public class TipoPuntoEquilibrioFiltro extends AbstractFilter {

	// ---------------------------------------------------------------------------------------------------------------------------

	public TipoPuntoEquilibrioFiltro() {
		_levelDefault = 0;
	}
	...
	public boolean equals(Object obj) {
		...
		TipoPuntoEquilibrioFiltro other = (TipoPuntoEquilibrioFiltro) obj;
