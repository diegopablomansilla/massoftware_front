...
public class UtilSQLView {
	...
	static void buildSelectAtts(int levelMax, int level, Clazz clazz, List<String> fields) {
	...
	static void buildSelectAttsLeftJoin(int levelMax, int level, Clazz clazz, List<String> fields) {
