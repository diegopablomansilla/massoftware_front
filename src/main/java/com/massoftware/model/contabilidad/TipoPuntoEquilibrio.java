...
@ClassLabelAnont(singular = "Tipo punto equilibrio", plural = "Tipos de puntos equilibrio", singularPre = "el tipo de punto equilibrio", pluralPre = "los tipos de puntos equilibrio")
public class TipoPuntoEquilibrio extends EntityId {
	...
	public TipoPuntoEquilibrio() throws Exception {
	}

	public TipoPuntoEquilibrio(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
