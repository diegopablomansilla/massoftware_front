...
@ClassLabelAnont(singular = "Módulo", plural = "Módulos", singularPre = "el módulo", pluralPre = "los módulo")
public class AsientoContableModulo extends EntityId {
	...
	public AsientoContableModulo() throws Exception {
	}

	public AsientoContableModulo(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
