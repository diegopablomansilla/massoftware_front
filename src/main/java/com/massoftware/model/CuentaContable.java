...
public class CuentaContable extends EntityId {
	...
	@FieldConfAnont(label = "Integra", required = true, columns = 16, maxLength = 16, mask = "9.99.99.99.99.99") // STARTS_WITCH
	...
	public List<CuentaContable> find(int limit, int offset, Map<String, Boolean> orderBy, CuentasContableFiltro filtro)
			throws Exception {
