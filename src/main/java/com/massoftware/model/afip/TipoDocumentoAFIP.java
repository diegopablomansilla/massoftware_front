...
@ClassLabelAnont(singular = "Tipo de documento", plural = "Tipos de documentos", singularPre = "el tipo de documento", pluralPre = "los tipos de documentos")
public class TipoDocumentoAFIP extends EntityId {
	...
	public TipoDocumentoAFIP() throws Exception {
	}

	public TipoDocumentoAFIP(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
