...
public class Banco2 extends EntityId {	
	...
	public List<Banco2> find(BancosFiltro filtro) throws Exception {
		return find(-1, -1, null, filtro);
	}

	public List<Banco2> find(int limit, int offset, Map<String, Boolean> orderBy, BancosFiltro filtro)
			throws Exception {

		filtro.setterTrim();

		List<Banco2> listado = new ArrayList<Banco2>();
