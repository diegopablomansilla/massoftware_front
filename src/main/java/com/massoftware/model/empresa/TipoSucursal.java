...
@ClassLabelAnont(singular = "Tipo de sucursal", plural = "Tipos de sucursales", singularPre = "el tipo de sucursal", pluralPre = "los tipos de sucursales")
public class TipoSucursal extends EntityId {
	...
	// Nº tipo de sucursal
	@FieldConfAnont(label = "Nº tipo de sucursal", labelError = "", unique = true, readOnly = false, required = true, columns = 20.0f, maxLength = 10, minValue = "1", maxValue = "2147483647", mask = "")
	...
	public TipoSucursal() throws Exception {
	}

	public TipoSucursal(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
