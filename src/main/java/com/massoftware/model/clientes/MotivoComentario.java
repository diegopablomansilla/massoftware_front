...
@ClassLabelAnont(singular = "Motivo de comentario", plural = "Motivos de comentario", singularPre = "el motivo de comentario", pluralPre = "los motivos de comentario")
public class MotivoComentario extends EntityId {
	...
	public MotivoComentario() throws Exception {
	}

	public MotivoComentario(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
