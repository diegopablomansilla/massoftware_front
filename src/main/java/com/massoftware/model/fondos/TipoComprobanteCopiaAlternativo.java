...
public class TipoComprobanteCopiaAlternativo extends EntityId {
	...
	public TipoComprobanteCopiaAlternativo() throws Exception {
	}

	public TipoComprobanteCopiaAlternativo(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
