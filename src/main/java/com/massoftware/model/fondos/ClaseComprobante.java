...
@ClassLabelAnont(singular = "Clase", plural = "Clases", singularPre = "la clase", pluralPre = "las clases")
public class ClaseComprobante extends EntityId {
	...
	// Nº clase
	@FieldConfAnont(label = "Nº clase", labelError = "", unique = true, readOnly = false, required = true, columns = 20.0f, maxLength = 10, minValue = "1", maxValue = "2147483647", mask = "")
	...
	public ClaseComprobante() throws Exception {
	}

	public ClaseComprobante(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
