...
public class JuridiccionConvnioMultilateral extends EntityId {
	...
	// Nº juridicción
	@FieldConfAnont(label = "Nº juridicción", labelError = "", unique = true, readOnly = false, required = true, columns = 20.0f, maxLength = 10, minValue = "1", maxValue = "2147483647", mask = "")
	...
	public void setter(String idArg0, Integer numeroArg1, String nombreArg2, String idCuentaFondoArg3) throws Exception {
