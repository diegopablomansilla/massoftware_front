...
@ClassLabelAnont(singular = "Tipo de banco", plural = "Tipos de bancos", singularPre = "el tipo de banco", pluralPre = "los tipos de bancos")
public class CuentaFondoTipoBanco extends EntityId {
	...
	public CuentaFondoTipoBanco() throws Exception {
	}

	public CuentaFondoTipoBanco(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
