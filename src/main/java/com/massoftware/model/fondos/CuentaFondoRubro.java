...
@ClassLabelAnont(singular = "Rubro de cuenta fondo", plural = "Rubros de cuenta fondo", singularPre = "el rubro de cuenta fondo", pluralPre = "los rubros de cuenta fondo")
public class CuentaFondoRubro extends EntityId {
	...
	// Nº rubro
	@FieldConfAnont(label = "Nº rubro", labelError = "", unique = true, readOnly = false, required = true, columns = 20.0f, maxLength = 10, minValue = "1", maxValue = "2147483647", mask = "")
	...
	public CuentaFondoRubro() throws Exception {
	}

	public CuentaFondoRubro(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
