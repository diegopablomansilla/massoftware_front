...
@ClassLabelAnont(singular = "Tipo de cuenta fondo", plural = "Tipos de cuenta fondo", singularPre = "el tipo de cuenta fondo", pluralPre = "los tipos de cuenta fondo")
public class CuentaFondoTipo extends EntityId {
	...
	public CuentaFondoTipo() throws Exception {
	}

	public CuentaFondoTipo(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
