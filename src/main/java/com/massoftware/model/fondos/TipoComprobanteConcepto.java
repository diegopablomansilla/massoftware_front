...
@ClassLabelAnont(singular = "Concepto", plural = "Conceptos", singularPre = "el concepto", pluralPre = "los conceptos")
public class TipoComprobanteConcepto extends EntityId {
	...
	public TipoComprobanteConcepto() throws Exception {
	}

	public TipoComprobanteConcepto(String idArg0, String codigoArg1, String nombreArg2) throws Exception {
