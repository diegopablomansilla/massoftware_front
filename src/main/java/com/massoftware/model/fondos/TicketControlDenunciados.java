...
@ClassLabelAnont(singular = "Control denunciados", plural = "Control denunciados", singularPre = "el control denunciados", pluralPre = "los controles denunciados")
public class TicketControlDenunciados extends EntityId {
	...
	// Nº control
	@FieldConfAnont(label = "Nº control", labelError = "", unique = true, readOnly = false, required = true, columns = 20.0f, maxLength = 10, minValue = "1", maxValue = "2147483647", mask = "")
	...
	public TicketControlDenunciados() throws Exception {
	}

	public TicketControlDenunciados(String idArg0, Integer numeroArg1, String nombreArg2) throws Exception {
