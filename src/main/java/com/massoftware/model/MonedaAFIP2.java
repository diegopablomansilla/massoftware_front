...
public class MonedaAFIP2 extends EntityId {
	...
	public List<MonedaAFIP2> find(int limit, int offset, Map<String, Boolean> orderBy, MonedasAFIPFiltro filtro)
			throws Exception {

		filtro.setterTrim();

		List<MonedaAFIP2> listado = new ArrayList<MonedaAFIP2>();
